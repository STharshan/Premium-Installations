      ...
      <div className="max-w-[1440px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
        ...
        <div className="lg:col-span-5 space-y-8">
          <div className="space-y-3">
            ...
            {heroLevel ? (
              <h1 className="max-w-md text-4xl font-bold uppercase tracking-tight leading-[1.1] sm:text-5xl">
                Construction Service To Our Clients
              </h1>
            ) : (
              <h2 className="max-w-md text-4xl font-bold uppercase tracking-tight leading-[1.1] sm:text-5xl">
                Construction Service To Our Clients
              </h2>
            )}
          </div>
              ...
              return (
                <Link
                  ...
                  className={`w-full flex items-center justify-between p-5 rounded-full transition-all duration-300 text-left group ${
                    isSelected 
                      ? 'bg-white text-[#0f0f0f] font-semibold pl-8 shadow-lg shadow-black/5' 
                      : 'bg-[#ebe7e3] text-[#545454] hover:bg-[#ffffff] hover:text-[#0f0f0f] border border-[#c6c5c1]'
                  }`}
                >
                  ...
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 ${
                    isSelected ? 'bg-[#2b2b2b] text-white' : 'bg-[#c6c5c1] text-[#545454] group-hover:bg-[#8a8a8a] group-hover:text-white'
                  }`}>
        ...
        <div className="lg:col-span-7 lg:pl-6 space-y-8">
          ...
          <div className="relative w-full h-[460px] sm:h-[540px] z-10">
            ...
            <div className="absolute inset-0 overflow-hidden rounded-[50px] rounded-br-[140px] border border-[#c6c5c1] bg-[#ebe7e3]">
            ...
            <div className="absolute bottom-[-4px] right-[-4px] z-20 bg-[#fafaf8] pl-8 pt-8 rounded-tl-[40px]">
              <Link to={`/services/${activeService.slug}`} className="flex items-center gap-4 bg-white text-[#0f0f0f] pl-7 pr-2 py-2 rounded-full font-bold text-xs uppercase tracking-wider transition-all duration-300 hover:bg-[#ebe7e3] group shadow-2xl shadow-black/10">
                Discover More
                <div className="w-10 h-10 rounded-full bg-[#2b2b2b] text-white flex items-center justify-center group-hover:rotate-45 transition-transform duration-300">
          ...
          <div className="min-h-[120px] pt-4 max-w-xl">
            <AnimatePresence mode="wait">
              ...
              >
                {heroLevel ? (
                    <h2 className="text-2xl sm:text-3xl font-extrabold uppercase tracking-tight text-[#0f0f0f]">
                    {activeService.title}
                  </h2>
                ) : (
                  <h3 className="text-2xl sm:text-3xl font-extrabold uppercase tracking-tight text-[#0f0f0f]">
                    {activeService.title}
                  </h3>
                )}
                <p className="text-[#545454] text-sm sm:text-base leading-relaxed font-light">
