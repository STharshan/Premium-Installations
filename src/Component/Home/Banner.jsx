...
const Banner = () => {
  return (
    <section className="relative w-full max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-neutral-900 min-h-[500px] sm:min-h-[600px] md:min-h-[650px] lg:min-h-[700px] flex items-end">
        ...
        <div className="relative z-10 w-full p-4 sm:p-8 md:p-12 lg:p-16 flex justify-end items-end">
          ...
          {/* White Card */}
          <div className="relative bg-white text-neutral-800 p-6 sm:p-8 md:p-10 rounded-3xl max-w-xl shadow-xl w-full md:w-[450px] lg:w-[500px]">
            ...
            <div className="flex items-center justify-between gap-4 mb-4 text-xs sm:text-sm font-semibold tracking-wide">
              <span className="text-orange-600 uppercase">Builder</span>
            ...
            {/* Main Title */}
            <h1 className="text-3xl sm:text-4xl font-bold text-neutral-900 mb-4 tracking-tight leading-tight">
            ...
            <div className="absolute -bottom-6 right-6 sm:right-12 z-20 flex items-center justify-center">
              ...
              <button className="w-12 h-12 sm:w-14 sm:h-14 bg-orange-600 rounded-full flex items-center justify-center text-white shadow-lg hover:bg-orange-700 transition-colors duration-200 group">
                <svg
