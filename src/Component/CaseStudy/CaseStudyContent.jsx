...
export default function ArupCaseStudyPage() {
  ...
  return (
    <div className="bg-black text-white min-h-screen font-sans selection:bg-neutral-800 antialiased selection:text-white">
      ...
      <section className="max-w-[1440px] mx-auto px-6 pt-10 pb-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-stretch">
          ...
          <div className="lg:col-span-8 relative aspect-[16/10] bg-neutral-900 overflow-hidden rounded-xs">
            <img
          ...
          <div className="lg:col-span-4 flex flex-col gap-4">
            <div className="flex-1 relative aspect-[16/10] lg:aspect-auto overflow-hidden bg-neutral-900 border border-neutral-900/40 rounded-xs">
              <img
        ...
        <div className="flex justify-center items-center gap-4 mt-8 w-full">
          <button
            onClick={triggerPrev}
            className="w-12 h-12 bg-white text-black hover:bg-neutral-200 active:scale-95 transition-all flex items-center justify-center cursor-pointer rounded-full shadow-lg"
          ...
          <div className="flex items-center gap-2">
            {CASE_STUDY_IMAGES.map((_, idx) => (
              <span 
                key={idx}
                className={`h-1.5 transition-all duration-300 rounded-full ${idx === currentSlideIndex ? 'w-6 bg-white' : 'w-1.5 bg-neutral-600'}`}
              />
            ))}
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-8 space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-6 border-t border-neutral-900">
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2.5 text-sm text-neutral-300 font-medium">
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 bg-[#B62025] dark:bg-[#FF4B4B] rounded-full" />
                    Arup Acoustics
                  </li>
                  <li className="flex items-center gap-2">
              ...
              <div className="border-l-2 border-[#B62025] dark:border-[#FF4B4B] pl-5 space-y-2">
                <p className="text-sm text-neutral-300 font-medium italic leading-relaxed">
                ...
                <span className="block text-xs font-semibold uppercase text-neutral-500 tracking-wider pt-1">
            ...
            <div className="pt-6 text-neutral-400 text-sm leading-relaxed max-w-3xl">
              <p>
              ...
              <div className="inline-flex items-center gap-1.5 text-xs text-[#B62025] dark:text-[#FF4B4B] font-bold uppercase tracking-wider mt-4 cursor-pointer hover:underline">
                <span>↓ Read more</span>
              </div>
            </div>
          ...
          <div className="lg:col-span-4 border-t lg:border-t-0 border-neutral-900 pt-8 lg:pt-0 space-y-6">
      ...
      <section className="mt-8 border-t border-neutral-900 bg-neutral-950">
        ...
        <div className="relative w-full h-[55vh] min-h-[420px] bg-neutral-900 overflow-hidden">
          <img
